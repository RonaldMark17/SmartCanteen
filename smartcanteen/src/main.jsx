import './services/secureStorage.js'
...
if (!isDesktopRuntime && canUseLocalServiceWorker && 'serviceWorker' in navigator) {
...
} else if (!isDesktopRuntime && import.meta.env.PROD && 'serviceWorker' in navigator) {
  window.addEventListener('load', () => {
