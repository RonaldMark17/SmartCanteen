...
function AuthenticatedWorkspace() {
  ...
  const routeElements = {
    ...
    inventory: <Inventory />,
    analytics: <Analytics />,
    financialManagement: <FinancialReports mode="financial-management" />,
    financialReports: <Navigate to="/financial-management" replace />,
    dailySales: <Navigate to="/financial-management?tab=daily-sales" replace />,
    expenseManagement: <Navigate to="/financial-management?tab=expenses" replace />,
